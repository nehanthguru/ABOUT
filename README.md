...
<body>
	...
	<table id="header" border="0" width="100%"
		cellpadding="0" cellspacing="0" bgcolor="#45A29E">
		<tr>
			<td>
					...
					<tr>
						...
						<td width="60%">
							<font face="Verdana" size="4"
								...
								website.
								<hr color="black">
								I am Nehanth, from Kodad, Telangana.
                                I am pursuing b.tech in                                                 Computer science and engineering at                                     Vellore Institute of Technology (VIT)                                   AP. I am interested in learning various                                 programming languages.
								<hr color="black">
				...
				<table border="0" cellpadding="15"
					...
					<tr>
						<td height="180" align="center" valign="middle">
							<font face="Verdana" size="7" color="#66FCF1">
								Education
								<hr color="#66FCF1" width="100">
							</font>
						</td>
					</tr>
					...
					<tr>
						<td>
							<font face="Verdana" size="4" color="#C5C6C7">
								<ul>
									<li>
									...
									<li>
										...
										<ul>
											...
											<li>
                                                1st year Student of Vellore institute of technology AP
											</li>
											<hr color="black">
											<hr color="black">
											<hr color="black">
